...
function HybridNode(props: HybridNodeProps) {
	...
	return (
		<div className="relative h-9 w-14 border border-black">
			<div className="absolute left-0 right-0 top-9 flex flex-col items-center border text-black">
				<input
			...
			<div className="absolute -left-2 top-[25px] h-2 w-2 bg-black"></div>
			<div className="text-1 absolute -left-10 top-1 scale-50 text-black">
				<p>50W</p>
				<p>Load</p>
			</div>
