					...
					<AnimatePresence>
						{!pop && (
							<motion.div
								...
								className={`relative h-full w-full overflow-hidden rounded-[30px] p-4 px-6`}
							>
								<motion.div
								...
								<div className="absolute left-[450px] top-12 h-14 w-14 rotate-[10deg]">
									<svg
										// width="160"
										// height="160"
										viewBox="0 0 160 160"
								...
								<div className="absolute left-[490px] top-24 h-8 w-8 rotate-[10deg]">
									<svg
										// width="160"
										// height="160"
										viewBox="0 0 160 160"
							...
							>
								<div className="mt-12 flex flex-col space-y-4 sm:px-12">
									<div className="flex flex-col items-start justify-start space-x-0 space-y-2 sm:flex-row sm:items-center sm:space-x-12 sm:space-y-0">
										...
										<GlowLink href="https://fifth-tees.vercel.app">
											Check it out
										</GlowLink>
									</div>
								...
								<p className="text-md font-light leading-relaxed text-neutral-400 sm:px-12 sm:text-xl sm:leading-relaxed">
									...
									t-shirt designs, which I&apos;ve been selling on
									print-on-demand websites. I decided to challenge myself and
									build the website from scratch. It&apos;s built using Next.js,
									React, Redux Toolkit, Tailwind CSS, and Firebase. The site
									includes features like user authentication, light and dark
									mode, as well as persisting user cart and wishlist items
									between sign-in sessions. Throughout the journey of building
									this app, I&apos;ve gained a solid understanding of concepts
									like server and client components, state management, and
									I&apos;ve generally had a lot of fun.
								</p>
								<WebFrame>
									<Image
										width={1000}
